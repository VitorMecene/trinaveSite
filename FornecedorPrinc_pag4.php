        ...
        <div class="container-fluid">
                <div class="row">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="FornecedorPrinc_pag4.php" role="tab" aria-controls="v-pills-home" aria-selected="true">Principal</a>
                        <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="RegistroCliente_pag5.php" role="tab" aria-controls="v-pills-home" aria-selected="false">Cadastre seus Clientes</a>
                    ...
                    <div class="row"><div class="col row justify-content-center rounded"></div><div class="col mr-5"><h3>Bem Vindo!</h3><br></div><div class="col"></div></div>
                    </div>
                </div>
            </div>
        </section>
